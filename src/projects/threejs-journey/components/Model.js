...
//   const bakedTexture = useTexture('/assets/project-model/project1/baked-02.jpeg')
//   const { nodes } = useGLTF('/assets/project-model/project1/portal-2.glb')

  const bakedTexture = useTexture(require('./baked-02.jpeg'))
  const { nodes } = useGLTF(require('./portal-2.glb'))
...
useGLTF.preload(require('./portal-2.glb'))